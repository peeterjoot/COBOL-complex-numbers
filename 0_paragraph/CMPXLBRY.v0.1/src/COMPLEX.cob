      ...
      *CONFIGURATION SECTION.
       ...
       COPY COMPLEXT REPLACING LEADING ==PRFX== BY ==WS-V1==.
       COPY COMPLEXT REPLACING LEADING ==PRFX== BY ==WS-V2==.

       COPY COMPLEXT REPLACING LEADING ==PRFX== BY ==WS-CONJPARM==.

       COPY COMPLEXT REPLACING LEADING ==PRFX== BY ==WS-REALPARM==.

       COPY COMPLEXT REPLACING LEADING ==PRFX== BY ==WS-IMAGPARM==.

       COPY COMPLEXT REPLACING LEADING ==PRFX== BY ==WS-MULTPARM-IN1==.
       COPY COMPLEXT REPLACING LEADING ==PRFX== BY ==WS-MULTPARM-IN2==.
       COPY COMPLEXT REPLACING LEADING ==PRFX== BY ==WS-MULTPARM-OUT==.

       COPY COMPLEXT REPLACING LEADING ==PRFX== BY ==WS-ADDPARM-IN1==.
       COPY COMPLEXT REPLACING LEADING ==PRFX== BY ==WS-ADDPARM-IN2==.
       COPY COMPLEXT REPLACING LEADING ==PRFX== BY ==WS-ADDPARM-OUT==.

       COPY COMPLEXT REPLACING LEADING ==PRFX== BY ==WS-SUBPARM-IN1==.
       COPY COMPLEXT REPLACING LEADING ==PRFX== BY ==WS-SUBPARM-IN2==.
       COPY COMPLEXT REPLACING LEADING ==PRFX== BY ==WS-SUBPARM-OUT==.

       COPY COMPLEXT REPLACING LEADING ==PRFX== BY ==WS-DIVPARM-IN1==.
       COPY COMPLEXT REPLACING LEADING ==PRFX== BY ==WS-DIVPARM-IN2==.
       COPY COMPLEXT REPLACING LEADING ==PRFX== BY ==WS-DIVPARM-OUT==.

       COPY COMPLEXT REPLACING LEADING ==PRFX== BY ==WS-INVPARM-IN==.
       COPY COMPLEXT REPLACING LEADING ==PRFX== BY ==WS-INVPARM-OUT==.
       COPY FLOAT REPLACING LEADING ==PRFX== BY ==WS-INV-MAGNITUDE==.

       COPY COMPLEXT REPLACING LEADING ==PRFX== BY ==WS-NEGPARM-IN==.
       COPY COMPLEXT REPLACING LEADING ==PRFX== BY ==WS-NEGPARM-OUT==.

       COPY COMPLEXT REPLACING LEADING ==PRFX== BY ==WS-DISPPARM==.

       COPY FLOAT REPLACING LEADING ==PRFX== BY ==WS-REAL==.

       COPY FLOAT REPLACING LEADING ==PRFX== BY ==WS-IMAG==.
