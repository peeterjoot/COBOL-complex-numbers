      ...
      *LOCAL-STORAGE SECTION.
       COPY GA20.
       COPY MVI      REPLACING LEADING ==PRFX== BY ==A==.
       COPY MVI      REPLACING LEADING ==PRFX== BY ==B==.
       COPY MVI      REPLACING LEADING ==PRFX== BY ==C==.
       COPY MVI      REPLACING LEADING ==PRFX== BY ==D==.
       COPY MVI      REPLACING LEADING ==PRFX== BY ==K==.
       COPY MVI      REPLACING LEADING ==PRFX== BY ==S1==.
       COPY MVI      REPLACING LEADING ==PRFX== BY ==S2==.
       COPY MVI      REPLACING LEADING ==PRFX== BY ==R==.
       COPY FLOATI   REPLACING LEADING ==PRFX== BY ==ZS==.
       COPY FLOATI   REPLACING LEADING ==PRFX== BY ==ONE-S==.
       COPY FLOATI   REPLACING LEADING ==PRFX== BY ==TWO-S==.
       COPY FLOATI   REPLACING LEADING ==PRFX== BY ==THREE-S==.
       COPY FLOATI   REPLACING LEADING ==PRFX== BY ==FOUR-S==.
       COPY MVI      REPLACING LEADING ==PRFX== BY ==ONE==.
       COPY MVI      REPLACING LEADING ==PRFX== BY ==E1==.
       COPY MVI      REPLACING LEADING ==PRFX== BY ==E2==.
       COPY MVI      REPLACING LEADING ==PRFX== BY ==E12==.
       COPY INTEGERI REPLACING LEADING ==PRFX== BY ==WS-GR==.
       COPY GADISPT  REPLACING LEADING ==PRFX== BY ==WS-DISPPARM==.
       PROCEDURE DIVISION.
