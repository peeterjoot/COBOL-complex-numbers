       ...
       COPY CMPXLBRY.
       COPY COMPLEX REPLACING LEADING ==PRFX== BY ==WS-V1==.
       COPY COMPLEX REPLACING LEADING ==PRFX== BY ==WS-V2==.
       COPY COMPLEX REPLACING LEADING ==PRFX== BY ==WS-V3==.

       COPY COMPLEX REPLACING LEADING ==PRFX== BY ==WS-CONJPARM==.

       COPY COMPLEX REPLACING LEADING ==PRFX== BY ==WS-MULTPARM-OUT==.

       COPY COMPLEX REPLACING LEADING ==PRFX== BY ==WS-ADDPARM-OUT==.
       COPY COMPLEX REPLACING LEADING ==PRFX== BY ==WS-SUBPARM-OUT==.

       COPY COMPLEX REPLACING LEADING ==PRFX== BY ==WS-DIVPARM-OUT==.
       COPY COMPLEX REPLACING LEADING ==PRFX== BY ==WS-INVPARM-OUT==.

       COPY FLOAT REPLACING LEADING ==PRFX== BY ==WS-SCALEPARM-IN==.
       COPY COMPLEX REPLACING LEADING ==PRFX== BY ==WS-SCALEPARM-OUT==.

       COPY FLOAT REPLACING LEADING ==PRFX== BY ==WS-REAL==.
       COPY FLOAT REPLACING LEADING ==PRFX== BY ==WS-IMAG==.

       COPY CDISPLAYT REPLACING LEADING ==PRFX== BY ==WS-DISPPARM==.
       COPY COMPLEX  REPLACING LEADING ==PRFX== BY ==WS-DISPPARM==.
       PROCEDURE DIVISION.
