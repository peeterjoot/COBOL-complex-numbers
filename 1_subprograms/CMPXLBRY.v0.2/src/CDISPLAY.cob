       ...
       WORKING-STORAGE SECTION.
        COPY FLOAT REPLACING LEADING ==PRFX== BY ==LK-TMP-IM==.
       LINKAGE SECTION.
        COPY CDISPLAYT REPLACING LEADING ==PRFX== BY ==LK-DISP-IN==.
        COPY COMPLEX REPLACING LEADING ==PRFX== BY ==LK-DISP-IN==.
       PROCEDURE DIVISION USING LK-DISP-IN-N, LK-DISP-IN-COMPLEX.
      ******************************************************************
      * @brief COMPLEX-DISPLAY
      *
