      ...
      ******************************************************************
       ...
       01  LK-S      TYPE REAL-T.
       01  LK-RESULT TYPE MV-T.
       PROCEDURE DIVISION USING BY VALUE LK-S RETURNING LK-RESULT.
       ...
       01  LK-Y      TYPE REAL-T.
       01  LK-RESULT TYPE MV-T.
       PROCEDURE DIVISION USING BY VALUE LK-X, LK-Y RETURNING LK-RESULT.
       ...
       01  LK-P      TYPE REAL-T.
       01  LK-RESULT TYPE MV-T.
       PROCEDURE DIVISION USING BY VALUE LK-P RETURNING LK-RESULT.
       ...
       01  LK-S      TYPE REAL-T.
       01  LK-RESULT TYPE MV-T.
       PROCEDURE DIVISION USING LK-A, BY VALUE LK-S RETURNING LK-RESULT.
       ...
       01  LK-RESULT TYPE MV-T.
       PROCEDURE DIVISION USING LK-A, BY VALUE LK-I RETURNING LK-RESULT.
